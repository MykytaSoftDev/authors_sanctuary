...
class Profile(TimeStampedModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_("phone number"), max_length=30, default="+19293211233")
    ...
    city = models.CharField(verbose_name=_("city"), max_length=180, default="New York City", blank=False, null=False)
